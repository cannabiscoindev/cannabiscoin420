...
static const int64 nTargetTimespan = 24 * 60 * 60; // CannabisCoin: 1 day
static const int64 nTargetSpacing = 42; // CannabisCoin: 1 minute
...
{
        static const int64 BlocksTargetSpacing = 42; // CannabisCoin: 1 minute
        static const unsigned int TimeDaySeconds = 24 * 60 * 60; // CannabisCoin: 1 day
...
bool SetBestChain(CValidationState &state, CBlockIndex* pindexNew)
{
    ...
    if (pindexBest->pprev)
        !CheckSyncCheckpoint(pindexBest->GetBlockHash(), pindexBest->pprev);
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x00000a10f7ce671e773330376ce892a6c0b93fbc05553ebbf659b11e3bf9188d");
    }
...
bool InitBlockIndex() {
 ...
 if (false && block.GetHash() != hashGenesisBlock)
        ...
        assert(block.hashMerkleRoot == uint256("0x2a4b0da444f96adf29d6bccf65fa6d558ccbbc4b0fc5c5b3088fc03d5c364558"));
...
unsigned char pchMessageStart[4] = { 0xfe, 0xc3, 0xb9, 0xde }; // CannabisCoin: increase each by adding 6 to bitcoin's value.
